# Behavioral Analysis — Book Guide
...
| 파일 | 변환 도구 |
|---|---|
| Cooper-ABA-summary.md | 요약 |
| Cooper-ABA_azure_full.md | Document Intelligence |
...
| 파일 | 변환 도구 |
|---|---|
| Kohavi-ABTesting-summary.md | 요약 |
| Kohavi-ABTesting_azure_full.md | Document Intelligence |

### Kohavi-ABTesting_azure
| 파일 | 변환 도구 |
|---|---|
| Kohavi-ABTesting_azure_full.md | Document Intelligence |
...
| 파일 | 변환 도구 |
|---|---|
| Montgomery-DOE-summary.md | 요약 |
| Montgomery-DOE_marker_full.md | Marker |

### Thaler-Nudge
| 파일 | 변환 도구 |
|---|---|
| Thaler-Nudge-summary.md | 요약 |
| Thaler-Nudge_azure_full.md | Document Intelligence |
...
### Montgomery-DOE
- **파일**: `Montgomery-DOE_marker_full.md`
- **총 라인 수**: ~9,150
- **주요 섹션** (108개):

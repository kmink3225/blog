...
book_sources:
  ...
  - group: glm
    path: docs/book/generalized_linear_model/
  ...
  - group: fda
    path: docs/book/functional_data_analysis/
    authors: Ramsay, Kokoszka
  - group: machine_learning
    path: docs/book/machine_learning/
    authors: TBD
  - group: deep_learning
    path: docs/book/deep_learning/
    authors: Goodfellow, Zhang, Raschka, Sutton, Jurafsky
  - group: data_science
    path: docs/book/data_science/
    authors: Huyen, Provost
  - group: strategy_frameworks
    path: docs/book/strategy_frameworks/
    authors: TBD
  - group: behavioral_analysis
    path: docs/book/behavioral_analysis/
    authors: TBD
  - group: psychology
    path: docs/book/psychology/
    authors: TBD
  - group: linguistics
    path: docs/book/linguistics/
    authors: TBD
  - group: governance
    path: docs/book/governance/
    authors: TBD
  - group: ontology
    path: docs/book/ontology/
    authors: TBD
---
...
### GLM/회귀 (`generalized_linear_model/`)
| 파일 | 저자 | 인용 약어 | 활용 |
|---|---|---|---|

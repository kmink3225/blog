...
total_pages: 294
language: en
keywords: [corpus-linguistics, concordance, annotation, collocation, frequency, corpus-driven, corpus-based, sociolinguistics, functionalism, psycholinguistics]
---

# Corpus Linguistics: Method, Theory and Practice — Summary

> Tony McEnery, Andrew Hardie (2012), 294 pages, 9 chapters
> 코퍼스 언어학의 기본 방법, 역사적 발전, 주요 이론적 접근법을 체계적으로 다루는 교과서이다.

## Contents

- List of figures / tables / Acknowledgements / Preface
- Ch 1: What is corpus linguistics?
- Ch 2: Accessing and analysing corpus data
- Ch 3: The web, laws and ethics
- Ch 4: English Corpus Linguistics
- Ch 5: Corpus-based studies of synchronic and diachronic variation
- Ch 6: Neo-Firthian corpus linguistics
- Ch 7: Corpus methods and functionalist linguistics
- Ch 8: The convergence of corpus linguistics, psycholinguistics and functionalist linguistics
- Ch 9: Conclusion

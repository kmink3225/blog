...
type: book-summary
source_file: "Introduction to functional data analysis-Chapman & Hall _ CRC (2017) - (Chapman & Hall_CRC texts in statistical science series) Kokoszka, Piotr_ Reimherr, Matthew.md"

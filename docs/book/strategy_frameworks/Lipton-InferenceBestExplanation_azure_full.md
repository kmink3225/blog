...
is  a n  instance  of  enumerative induction,  the  inference  should  be  de-
...
This  paper  is  based  on  one  read  at  the  December  1963  meetings  i n
Washington o f  the Eastern  Division  o f  the American  Philosophical Association.
I  wish t o  thank J. J .  Katz, R. P.  W o l f f ,  and  a reader for  the Philosophical Reuiew
for  their helpful comments.

Enumerative

induction  infers  from  observed  regularity  t o   universal

regularity  or  at  least  to regularity  in the next  instance.

IJVFERENCE  TO  BEST  EXPLANATION

"hypothetic  inference,"  "the  method  of  elimination,"  "eliminative
...
I n   making  this  inference  one  infers,  from  the  fact  that  a  certain
hypothesis would  explain the evidence,  to the truth of that hypothesis.
I n  general,  there  will  be  several  hypotheses  which  might  explain  the
...
hypothesis  is  sufficient-ly better  than  another  hypothesis.  Presumably
...
be  accepted.  When  a  scientist  infers  th'e  existence  of  atoms  and  sub-
...
I t   seems  to  me  that  these  examples  of  inference  (and,  of  course,
...
If,  however,  we  think  of  the  inference  as  an  inference  to  the  best
...
observed  sample in order to make us  think  that all A's  are R's.  O n  the
other hand, as soon as the total evidence makes some other, c-npeting
...
tive induction, if we describe these  inferences  as  instances  of  the  infer-
...
merative  inductiom3 Describing  our  inference  as  enumerative  induc-
...
I n  what follows, when  I speak of  "describing  a n  inference  as a n  instance
of  enumerative  induction,"  I  understand  this  phrase  to  rule  out  thought
of  the  inference  as  a n   instance  of  the  inference  to  the  best  explanation.  I
have  no  objection  to  talking  of  enumerative  induction  where  one recognizts
...
which  is  often  o ~ e r l o o k e d . ~I t   is  now  generally  acknowledged  by
...
(warranted)  i n f e r e n ~ e . ~

a

T o  illustrate  this condition, suppose I read on the philosophy  depart-
...
the  bulletin  board.  My  belief  that  Hampshire  will  read  a  paper  a t
...
see  Edmund  L.  Gettier,  "Is  Justified  True  Belief  Knowledge?,"
Analysis,  23  (1963),  I 2 1-123 and  Clark,  "Knowledge and  Grounds: A  Com-
...
First,  consider  what  lemmas  are used  in  obtaining  knowledge  from
...
book.  I t  is  obvious that mucli of our knowledge  is  based  on authority
...
of  the  inference.  O n  the  other  hand,  if  we  describe  the  inferences  as
then  we  obscure the role  of such
instances  of enumerative i n d ~ c t i o n , ~
...
only  if  we  remember  that  we  must  infer  an  explanation  of  the  data.
I n  the first example we infer  that the best explanation for our reading
...
I  have argued  that enumerative induction should  not be  considei-ed
...
explanation;  and  (b) we  can  best  account  for  certain  necessary  con-
...
Stable URL:
http://links.jstor.org/sici?sici=0003-2638%28196306%2923%3A6%3C121%3AIJTBK%3E2.0.CO%3B2-1

4 Knowledge and Grounds: A Comment on Mr. Gettier's Paper
Michael Clark
Analysis, Vol. 24, No. 2. (Dec., 1963), pp. 46-48.
Stable URL:
http://links.jstor.org/sici?sici=0003-2638%28196312%2924%3A2%3C46%3AKAGACO%3E2.0.CO%3B2-H

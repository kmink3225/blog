...
![Service Instance Creation](./images/docu-intel-create.png){width="70%"}  
  ...
  - pricing tier: 초기 사용자는 2개의 옵션이 있다  
    - F0: 무료 할당량과 제한된 기능으로 서비스를 test 해볼 수 있다.  
      ...
      - adds on 기능 사용 못함 (formula 집중 추출 등)  
       ...
       ![F0 Service in Content Understand Studio](./images/docu-intel-setting-basic-F0-service.png){width="70%"}  

    - Standard S0: 종량제 (프로덕션용), 모든 기능을 제한없이 이용할 수 있다.  

![Service Instance Setting-basic](./images/docu-intel-setting-basic.png){width="70%"}  
...
![Service Instance Setting-review + create](./images/docu-intel-setting-review.png){width="70%"}  
...
![Content Understand Studio](./images/docu-intel-setting-basic-F0-service.png){width="70%"}  

10. 세부 기능 선택  
  - 여러 기능들이 리스팅 되어 있다. 본인은 OCR/Read를 선택  
  - 기존 사용자라면 페이지 이동시 본인이 이용하고 있는 Azure Directory를 선택하여 전환해야할 수도 있다.  
  
![OCR/Read](./images/docu-intel-services.png){width="70%"}  

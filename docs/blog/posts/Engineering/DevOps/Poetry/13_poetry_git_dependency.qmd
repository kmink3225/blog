---
title: "Poetry git dependency — URL, 위치, PEP 508, 실무 패턴까지"
subtitle: Poetry, git dependency, pyproject.toml, PEP 508, 실무 일반화
description: |
  Poetry에서 외부 Git 저장소 패키지를 의존성으로 추가할 때의 URL 형식, pyproject.toml 위치, PEP 508 표준, SSH/HTTPS 인증, 패키지 이름/임포트 이름 분리, 실무 전환 전략 등 사례와 일반 원칙을 함께 정리한다.
categories:
  - Engineering
  - Python
  - Packaging

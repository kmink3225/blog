...
- [Python 빌드 시스템과 pyproject.toml 이해](./12_poetry-build-system-difference.qmd) — PEP 517/518 개념, sdist vs wheel, setuptools vs Poetry 비교 상세
- [Poetry git dependency — URL, 위치, PEP 508](./13_poetry-git-dependency.qmd) — git URL 구성과 Poetry 2.x 위치 문제
- [SSH 다계정 인증과 ~/.ssh/config alias](./14_poetry-ssh-auth-multi-account.qmd) — Private repo SSH 인증 전략

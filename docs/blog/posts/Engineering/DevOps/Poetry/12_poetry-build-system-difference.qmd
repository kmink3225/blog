...
- [Poetry 프로젝트에서 외부 Git 패키지 통합](./11_poetry-external-repo-connection.qmd) — 실전 사례: archive 상태 repo, pyproject.toml 없음, 빌드 시스템 불일치 해결
- [Poetry git dependency — URL, 위치, PEP 508](./13_poetry-git-dependency.qmd) — git URL 구성과 Poetry 2.x 위치 문제 실전 패턴

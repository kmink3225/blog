...
# 4. Git이 중간 커밋으로 자동 checkout
# → 이 상태에서 버그를 테스트
# → 버그 있으면: git bisect bad
# → 버그 없으면: git bisect good
...
# 출력 예시:
# abc1234 (홍길동  2024-03-01 10:30)  def main():
# def5678 (김영희  2024-03-05 14:22)      print("Hello")
# ghi9012 (홍길동  2024-03-10 09:15)      return True

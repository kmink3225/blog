...
subtitle: Overview
description: |
  자료구조는 다수의 데이터를 효율적으로 저장하고 처리하기 위한 구조다. 알고리즘 성능은 자료구조 선택에 따라 달라진다.
categories:
  - Engineering
  - Data Structure
author: Kwangmin Kim
...
-   시간 복잡도 속도 비교
    ...
    ![Time Complexity from Wiki](Comparison_computational_complexity.svg) [By Cmglee - Own work, CC BY-SA 4.0](https://commons.wikimedia.org/w/index.php?curid=50321072){width="50%"}

...
subtitle: BranchPython Operator (Branch Processing), @task.brancch (Branch Processing), BaseBranchOperator (Branch Processing), Trigger Rule Setting, Task Groups, Edge Labels  
description: |

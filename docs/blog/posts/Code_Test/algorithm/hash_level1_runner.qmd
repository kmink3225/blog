...
**공간복잡도**: O(n) (최악의 경우 모든 참가자가 서로 다른 이름)
...
**공간복잡도**: O(1) (입력 배열 자체를 정렬)
  - O(1) = 상수 시간 (Constant Time)
  - 입력 크기에 상관없이 항상 일정한 시간이 걸리는 연산
  - 즉, 추가 메모리를 거의 사용하지 않는다는 뜻
  - 모두 O(1) 연산들
...
**해시맵 방법**:
1. participant_dict = {"leo": 1, "kiki": 1, "eden": 1}
2. "eden" 차감 → {"leo": 1, "kiki": 1, "eden": 0}
3. "kiki" 차감 → {"leo": 1, "kiki": 0, "eden": 0}
4. count가 1인 "leo" 반환

### 예제 3: `["mislav", "stanko", "mislav", "ana"]`, `["stanko", "ana", "mislav"]`

**해시맵 방법**:
1. participant_dict = {"mislav": 2, "stanko": 1, "ana": 1}
2. 완주자들 차감 후 → {"mislav": 1, "stanko": 0, "ana": 0}
3. count가 1인 "mislav" 반환

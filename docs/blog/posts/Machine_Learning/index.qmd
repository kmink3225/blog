...
### ML for Longitudinal Data (종단 데이터 ML)
* 2026-03-07, [ML Overview: RSF, XGBoost, HMM, Lasso](./12-mixed-model-ml-longitudinal.qmd)
* 2026-03-08, [Random Survival Forest (RSF)](./21-mixed-model-ml-rsf.qmd)
* 2026-03-08, [XGBoost + 시간 피처 공학 (Temporal Feature Engineering)](./22-mixed-model-ml-xgboost.qmd)
* 2026-03-08, [Hidden Markov Model (HMM) for Longitudinal Data](./23-mixed-model-ml-hmm.qmd)
* 2026-03-08, [Lasso / Elastic Net / glmmLasso — 종단 데이터의 변수 선택](./24-mixed-model-ml-regularization.qmd)
...
* 딥러닝/강화학습 접근: [Deep Learning — DL/RL for Longitudinal Data](../Deep_Learning/index.qmd#dl-for-longitudinal-data)
...
* 2026-03-27, [Fine-tuning 학습 데이터 샘플 수 추정 — KoBERT 14-class 분류 사례](./25-sample-size-fine-tuning.qmd)
* 2026-04-15, [Train/Val/Test 분할 비율 선택 — 데이터 규모별 실무 가이드](./26-train-val-test-split-ratio.qmd)

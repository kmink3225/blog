...
SVD는 이 세 가지 문제를 **완벽하게** 해결한다. $m \times n$ 임의 행렬에 대해, 두 개의 직교 행렬 $\mathbf{U}$, $\mathbf{V}$ 와 대각 행렬 $\mathbf{\Sigma}$ 로 분해한다. Strang은 SVD를 "선형대수 강의의 클라이맥스"라 불렀다 (Strang, 2009, Ch.6.7).

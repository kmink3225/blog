...
- [고윳값과 고유벡터 (Lecture 21 강의 노트)](./mit-21-gilbert-strang-eigenvalue.qmd)
- [대각화와 행렬의 거듭제곱 (Lecture 22 강의 노트)](./mit-22-gilbert-strang-diagonalization.qmd)
- [미분 방정식과 행렬 지수 함수 (Lecture 23 강의 노트)](./mit-23-gilbert-strang-differentiation.qmd) — 같은 주제의 요약
- [마르코프 행렬과 푸리에 급수](./mit-24-gilbert-strang-markov-matrix.qmd) — 이산 동역학 대응

**후속 주제**

- [대칭 행렬과 양정치 판별](./mit-26-gilbert-strang-symmetric-matrices.qmd) — 실수 고유값 보장
- [양정치 행렬과 이차형식](./mit-28-gilbert-strang-positive-definite-matrices.qmd) — 에너지 함수와 안정성
- [닮음 행렬과 Jordan 표준형](./mit-29-gilbert-strang-similar-matrices.qmd) — 결함 행렬의 $te^{\lambda t}$ 항 처리

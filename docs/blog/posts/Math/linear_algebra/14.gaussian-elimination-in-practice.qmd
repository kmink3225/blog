...
선행 포스트 [수치 선형대수 개요](./13.numerical-linear-algebra-overview.qmd)에서 "직접법"으로 가우스 소거를 언급했는데, 여기서는 그 속을 열어본다.
...
- [수치 선형대수 개요](./13.numerical-linear-algebra-overview.qmd)
...
- [QR 분해와 최소제곱](./qr-decomposition-least-squares.qmd)
- [Cholesky 분해와 대칭 양정치](./cholesky-decomposition.qmd)
- [반복법: CG와 GMRES](./iterative-methods-cg-gmres.qmd)
- [조건수와 민감도 분석](./condition-number-sensitivity.qmd)

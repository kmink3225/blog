...
- [Ch.6 §6.6 — 닮음 행렬과 조르당 표준형](./mit-29-gilbert-strang-similar-matrices.qmd)
- Ch.6 §6.7 — 특이값 분해(SVD): $\mathbf{A}^\top \mathbf{A}$ 의 양정치성이 SVD의 출발점

**관련 개념**

- [Bilinear Form](./11.bilinear_form.qmd) — 이차형식의 쌍선형 확장
- [Special Matrices](./09.special_matrix.qmd) — 공분산 행렬, 중심 행렬
- [MIT 18.06 Lecture 28 (강의 노트)](./mit-28-gilbert-strang-positive-definite-matrices.qmd) — 본 포스트의 강의 노트 버전

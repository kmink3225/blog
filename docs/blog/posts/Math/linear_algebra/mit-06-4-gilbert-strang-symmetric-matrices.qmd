...
- [양정치 행렬과 이차형식](./mit-28-gilbert-strang-positive-definite-matrices.qmd) — 양정치 판별 네 가지 조건
- [복소 행렬과 고속 푸리에 변환](./mit-27-gilbert-strang-complex-matrices.qmd) — 에르미트 행렬로의 확장
- [Singular Value Decomposition (SVD)](./11.bilinear_form.qmd) — 비대칭 행렬에 대한 일반화

**관련 강의 노트**

- [Lecture 26 — 대칭 행렬과 양정치 판별 (강의 노트)](./mit-26-gilbert-strang-symmetric-matrices.qmd) — 실수성 증명 및 양정치 판별 조건
- [Lecture 21 — 고윳값과 고유벡터 (강의 노트)](./mit-21-gilbert-strang-eigenvalue.qmd) — 기초 개념
- [Lecture 22 — 대각화와 행렬의 거듭제곱](./mit-22-gilbert-strang-diagonalization.qmd) — $\mathbf{A}^k$ 계산

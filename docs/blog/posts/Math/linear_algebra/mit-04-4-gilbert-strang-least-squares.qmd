...
- [투영 행렬과 최소자승법 심화](./mit-16-gilbert-strang-projection-matrix.qmd) — $\mathbf{A}^\top\mathbf{A}$ 가역성 심화
- [정규직교 기저와 그람-슈미트](./mit-17-gilbert-strang-gram-schmidt.qmd) — QR 분해로 최소제곱 풀기

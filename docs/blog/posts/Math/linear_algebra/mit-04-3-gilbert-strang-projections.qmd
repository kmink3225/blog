...
- [투영과 최소자승법 (강의노트)](./mit-15-gilbert-strang-projection.qmd) — 강의 기반 요약
- [투영 행렬과 최소자승법 심화](./mit-16-gilbert-strang-projection-matrix.qmd) — §4.3 최소제곱법 연결
- [정규직교 기저와 그람-슈미트](./mit-17-gilbert-strang-gram-schmidt.qmd) — 투영 공식이 단순해지는 기저

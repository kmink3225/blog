...
세부 도해와 4 부분공간 해석은 [MIT Lecture 12 — 그래프, 네트워크, 근접 행렬](./mit-12-gilbert-strang-graph.qmd) 에서 확장된다.
...
- [MIT Lecture 12 — 그래프, 네트워크, 근접 행렬](./mit-12-gilbert-strang-graph.qmd) — §8.2 의 강의노트 버전
- [MIT Lecture 24 — 마르코프 행렬과 푸리에 급수](./mit-24-gilbert-strang-markov-matrix.qmd) — §8.3, §8.5 의 강의노트 버전

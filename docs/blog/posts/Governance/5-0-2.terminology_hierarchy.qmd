...
-   This hierarchy works across different domains by systematically mapping how language components evolve from general words to specialized terms.
-   The **contextual examples** highlight how Nomenclature-Based Terms are distinct but complement the broader Terminology structure. \### 주요 포인트

1.  **용어(term)**는 가장 기본적인 단위입니다.\
2.  **Terminology**는 특정 분야에서 용어들을 체계화한 집합입니다.\
3.  **Glossary**는 문서나 주제에 한정된 용어의 목록입니다.\
4.  **Nomenclature**와 **Ontology**는 용어의 명명법과 관계를 정의하는 데 초점을 둡니다.
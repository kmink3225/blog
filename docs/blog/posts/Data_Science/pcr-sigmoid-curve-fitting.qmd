...
description: |
  RT-PCR 신호에 4PL sigmoid 모델을 피팅하여 추정된 매개변수를 좌표계로 활용,
  양성·음성 분포에서의 Mahalanobis 거리를 계산하고 Posterior 확률을 도출하는 과정을 설명한다.
  통계적 검정(p-value)이 결정 도구가 아니라 QC 도구임을 명확히 한다.
categories:
  - Data Science
  - Statistics
  - Surveilance

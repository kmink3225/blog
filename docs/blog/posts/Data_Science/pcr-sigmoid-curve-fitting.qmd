...
- [RT-PCR 4PL 모델 — 증폭 효율 계산과 로그 밑 선택의 원리](./pcr-4pl-amplification-efficiency.qmd) — 4PL 모델 매개변수와 $E = 10^b - 1$ 도출

**연관 포스트 — PCR 시리즈**

- [PCR 신호 처리 파이프라인 리팩토링](./pcr-signal-pipeline-refactoring.qmd) — 진단 알고리즘의 엔지니어링 구현
- [RT-PCR RFU 시계열 분석](./pcr-rfu-time-series-analysis.qmd) — 배치 간 QC 및 드리프트 보정

**연관 카테고리**

- [Surveilance — 의료기기 규제](../Surveilance/index.qmd) — FDA 510(k), 21 CFR 809.10 규제 프레임워크
- [Machine Learning — 분류 알고리즘](../Machine_Learning/index.qmd) — 확률 분류기, Bayesian inference
- [Statistics — 통계 추론](../Statistics/index.qmd) — Likelihood, Posterior, 신뢰구간

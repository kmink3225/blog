...
1. [Introduction to Data Science](./0.intro.qmd)
2. [Basic Concepts Supplement](./00-basic-concept-supplement.qmd)
3. [Performance Index (F1 Score)](./performance-index.qmd)
4. [함수의 합 vs 합성함수 — Sequential vs Joint 추정](../Math/function/function_addition_vs_composition.qmd)
4. [산술·기하·조화평균의 직관적 이해](../Math/mean.qmd)
---
...
* 2025-01-12, [RT-PCR 4PL 증폭 효율 분석](./pcr-4pl-amplification-efficiency.qmd)

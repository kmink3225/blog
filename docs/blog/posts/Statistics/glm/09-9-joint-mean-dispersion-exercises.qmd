---
title: "Ch.10 Exercises — 지수 이탈도 $7/6$·공통 모수·Table 10.1 유도·블록 대각 정보 (McCullagh §10.9)"
subtitle: "연습문제 10.1-10.4 풀이"
description: |
  McCullagh & Nelder Ch.10 의 네 연습문제를 풀이한다.
  (10.1) 지수 오차에서 감마 평균 이탈도가 $7/6$ 인 이유,
  (10.2) (10.7) 유도에서 $\beta, \gamma$ 공통 모수 배제 조건의 필요성,
  (10.3) Table 10.1 의 포아송·이항 첨도 계수 유도,
  (10.4) $Q^+$ 기반 기대 Fisher 정보 행렬의 블록 대각 구조.
categories:
  - Statistics
  - Regression
author: Kwangmin Kim
...
1. **Fisher 정보 블록 대각성이 깨짐** — $\theta_0$ 에 대한 정보가 $\beta$ 와 $\gamma$ 둘 다에 걸침.
...
- [확장 준-가능도 기준 $Q^+$ (McCullagh §10.4)](./09-4-extended-quasi-likelihood-criterion.qmd) — 블록 대각성 논의의 모체
- [추정식 보정 (McCullagh §10.5)](./09-5-dispersion-equation-adjustments.qmd) — Table 10.1 의 배경
- [공동 최적 추정 방정식 (McCullagh §10.6)](./09-6-joint-optimum-estimating-equations.qmd) — 10.2 의 조건
- [Leaf-spring 예제 (McCullagh §10.7)](./09-7-leaf-spring-example.qmd) — 10.1 의 수치 검증

**관련 개념**

- [Deviance 잔차의 Saddlepoint 근사 (McCullagh §2.4)](./01-5-glm-residuals.qmd) — 문제 10.1 의 기술적 뿌리
- [지수족의 누율 구조 (McCullagh Ch.2)](./01-1-glm-theory-foundation.qmd) — 문제 10.3 의 출발점

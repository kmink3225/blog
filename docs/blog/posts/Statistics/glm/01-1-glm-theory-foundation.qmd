...
## GLM 의 세 구성요소 (Three Components of a GLM)
...
### 구성요소를 따로 고르는 이유 (Why Separate the Components?)
...
### 주요 분포의 정준형 확인 (Verifying the Canonical Form for Major Distributions)
...
## 연결함수와 정준연결 (Link Functions and Canonical Links)

### 연결함수의 역할 (Role of the Link Function)
...
### 주요 분포의 이탈도 (Deviance for Major Distributions)
...
### 모형 비교: 이탈도 차이 (Model Comparison via Deviance Difference)
...
### 잔차의 세 유형 (Three Types of Residuals)
...
### 수렴과 정보행렬 (Convergence and the Information Matrix)
...
## 예시: 포아송 회귀 한 스텝 IRLS (Example: One IRLS Step for Poisson Regression)

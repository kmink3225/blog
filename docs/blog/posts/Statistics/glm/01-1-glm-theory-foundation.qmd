---
title: "GLM 이론 기초 — 지수족·정준연결·이탈도·IRLS"
subtitle: "McCullagh & Nelder 프레임워크의 수리적 뼈대"
description: |
...
- [GLM Process of Model Fitting (McCullagh §2.1)](./01-2-glm-process-of-model-fitting.qmd) — 모델 선택·추정·예측의 통합 워크플로우
- [GLM 개요 — 응용 통합 관점](./02-glm-applied-unification.qmd) — t-test·ANOVA 가 GLM 의 특수 사례임을 실무 예시로 설명
- [Logistic Regression: The Model](./logistic-regression-model.qmd) — 이항 GLM 의 구체 사례
- [Logistic Regression: Estimation](./logistic-regression-estimation.qmd) — IRLS·Newton-Raphson 의 이항 버전

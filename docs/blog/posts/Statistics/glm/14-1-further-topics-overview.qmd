...
- [Bias Adjustment — §15.2 심화](./14-2-bias-adjustment.qmd) — MLE 의 $O(n^{-1})$ 편향 보조 회귀 보정
- [Bartlett Adjustment — §15.3 심화](./14-3-bartlett-adjustment.qmd)
- [Generalized Additive Models — §15.4 심화](./14-4-generalized-additive-models.qmd)
- [Ch.15 Exercises — §15.6](./14-5-ch15-exercises.qmd) — 책의 마지막 연습문제

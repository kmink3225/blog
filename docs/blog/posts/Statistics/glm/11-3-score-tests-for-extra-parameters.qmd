...
- [Smoothing as an Aid to Informal Checks (McCullagh §12.4)](./11-4-smoothing-as-aid.qmd) — 비공식 진단 보조
- [Raw Materials of Model Checking — 잔차·햇·삭제잔차 (McCullagh §12.5)](./11-5-raw-materials-of-model-checking.qmd) — 진단의 기본 재료 상세
- [Checks for Systematic Departure — 분산·링크·공변량 척도 (McCullagh §12.6)](./11-6-checks-for-systematic-departure.qmd)

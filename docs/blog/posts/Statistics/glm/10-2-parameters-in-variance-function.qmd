...
이 모형은 McCullagh-Nelder 의 표준 GLM 프레임워크를 **벗어난다** — Ch.10 의 joint mean-dispersion 과 구조적으로 유사하나, $k$ 가 dispersion parameter 가 아니라는 점에서 다르다. 실무적으로 NBMM (Negative Binomial Mixed Model) 또는 GAMLSS 로 구현된다.

...
- [일표본 반복측정 MANOVA](./26-manova-repeated-measurements.qmd)

**연장 분석**

- [다표본 반복측정 MANOVA (s 집단)](./27-manova-repeated-s-sample.qmd)
...
- [단일 표본 반복측정 ANOVA 분해](./22-rm-anova-single-sample-decomposition.qmd) — 이 포스트의 단변량 결과(F=78.99)와 대응
- [다중 표본 반복측정 ANOVA](./23-rm-anova-multiple-sample-decomposition.qmd)

...
이 포스트는 [반복측정 ANOVA 개요](./21-anova-longitudinal-overview.qmd)와
[단일 표본 반복측정 ANOVA 심화](./22-rm-anova-single-sample-decomposition.qmd)의
다중 표본 확장이다.
...
- [반복측정 ANOVA 개요 — 단일·다중 표본, 구형성, 예제](./21-anova-longitudinal-overview.qmd)
...
- [종단 연구 개요 — ICC, 공분산 구조](./20-longitudinal-studies-overview.qmd)

...
- [Logistic Regression: The Model — GLM 3요소, 로짓, 오즈비 (Casella §12.3)](./151-logistic-regression-model.qmd)
...
- [양정치 행렬과 이차형식](../Math/linear_algebra/mit-28-gilbert-strang-positive-definite-matrices.qmd) — 이차형식 최소화와 직교 최소제곱의 선형대수적 배경

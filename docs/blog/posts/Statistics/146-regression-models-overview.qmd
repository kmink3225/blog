...
**상세**: [GLM — t-test부터 로지스틱 회귀까지](./31-glm.qmd)
...
- [GLM 프레임워크](./31-glm.qmd) — 지수족, 연결 함수, IRLS
- [Logistic Regression: The Model — GLM 3요소, 로짓, 오즈비](./151-logistic-regression-model.qmd)
- [Logistic Regression: Estimation — Newton-Raphson, IRLS, 이탈도](./152-logistic-regression-estimation.qmd)
...
- [선형대수 — 양정치 행렬](../Math/linear_algebra/mit-28-gilbert-strang-positive-definite-matrices.qmd) — Ridge의 $\mathbf{X}^T\mathbf{X} + \lambda\mathbf{I}$ 가역성

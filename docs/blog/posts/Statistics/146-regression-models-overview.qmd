...
**상세**: [GLM — t-test부터 로지스틱 회귀까지](./glm/02-glm-applied-unification.qmd)
...
- [GLM 프레임워크](./glm/02-glm-applied-unification.qmd) — 지수족, 연결 함수, IRLS
- [Logistic Regression: The Model — GLM 3요소, 로짓, 오즈비](./glm/logistic-regression-model.qmd)
- [Logistic Regression: Estimation — Newton-Raphson, IRLS, 이탈도](./glm/logistic-regression-estimation.qmd)

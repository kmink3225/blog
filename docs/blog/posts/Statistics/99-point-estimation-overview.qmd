...
기존 포스트 [BLUE (Best Linear Unbiased Estimator)](./147-blue.qmd)에서 MSE와 편향-분산 트레이드오프를 더 자세히 다루고 있다.
...
Rao-Blackwell 정리와 [완비성(completeness)](./146-data-reduction.qmd#완비통계량과-바수-정리-complete-statistics-basus-theorem)을 결합한 결정적 결과이다.
...
- [데이터 축소의 원리 (Overview)](./146-data-reduction.qmd) — 충분통계량, 완비성
...
- [BLUE (Best Linear Unbiased Estimator)](./147-blue.qmd)
...
- [구간추정 (Interval Estimation, Ch.9)](./146-data-reduction.qmd)

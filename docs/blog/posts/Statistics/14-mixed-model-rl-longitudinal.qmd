---
title: "RL for Longitudinal Data"
subtitle: "동적 처치 결정: Contextual Bandit, DTR, Offline RL"
description: |
  종단 데이터에서 강화학습을 활용한 동적 의사결정을 다룬다.
  A/B 테스트(정적)의 한계를 넘어 실시간으로 개인화 전략을 조정하는
  Contextual Bandit, 순차적 최적 처치를 학습하는 Dynamic Treatment Regime(DTR),
  그리고 기존 관찰 데이터로 정책을 학습하는 Offline RL을 설명한다.
  Agent Personalization 시리즈와 직접 연결된다.
categories:
  - Statistics

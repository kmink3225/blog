...
이 블로그의 Statistics 카테고리는 **Casella & Berger (2002)의 체계**를 뼈대로, 응용 분야를 확장하는 구조로 구성되어 있다.
전체 목차는 [Statistics Contents List](./index.qmd)에서 확인할 수 있다.
...
- [MLE와 통계적 편향](./101-maximum-likelihood-estimators.qmd)
- [지수족 개요](./55-common-families-overview.qmd)
- [데이터 축소의 원리](./95-1-data-reduction.qmd)
- [GLM 프레임워크](./glm/02-glm-applied-unification.qmd)
- [Mixed Model 로드맵](./32-mixed-model-roadmap.qmd)
- [생존 분석 개요](./survival/01-survival-overview.qmd)

**선행 지식 (Math 카테고리)**

- [벡터와 행렬 기초](../Math/linear_algebra/mit-01-1-gilbert-strang-vectors-overview.qmd)

---
title: "DL for Longitudinal Data"
subtitle: "LSTM, TCN, Transformer, Neural ODE — 시퀀스 학습과 연속 시간 역학"
description: |
  종단 데이터에 적용 가능한 딥러닝 기법을 다룬다.
  가변 길이 시퀀스를 처리하는 LSTM/GRU, 병렬 연산의 TCN,
  Attention 기반 Temporal Transformer, 그리고 연속 시간 역학을 모델링하는
  Neural ODE를 구체적인 예시와 함께 설명한다.
categories:
  - Statistics
  - Deep Learning
author: Kwangmin Kim

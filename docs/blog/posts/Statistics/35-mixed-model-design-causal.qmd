...
Randomized Controlled Trial(RCT)은 무작위 배정으로 confounding을 제거하는 최강의 설계다 ([32편 참조](./32-mixed-model-design-rct.qmd)). 그러나:
...
James Robins가 제안한 **G-methods**는 이 딜레마를 해결한다.
...
| 파일 | 주제 | 연결 포인트 |
|------|------|------------|
| [20 — 연구 설계 Overview](./20-mixed-model-study-design.qmd) | 전체 연구 설계 계보 | 인과 추론의 위치 |
| [32 — RCT & A/B Test](./32-mixed-model-design-rct.qmd) | 무작위 배정의 원칙 | 인과 추론이 불필요한 이상적 경우 |
| [33 — 관찰 연구](./33-mixed-model-design-observational.qmd) | 코호트, 케이스-컨트롤 | 인과 추론 도구가 필요한 이유 |
| [34 — 준실험적 설계](./34-mixed-model-design-quasi.qmd) | ITS, RDD, Stepped Wedge | 자연 실험 기반 인과 추론 |

...
**MANOVA**(Multivariate Analysis of Variance). 이전 포스트([반복측정 ANOVA](./170-anova-longitudinal-overview.qmd))에서
...
- [종단 연구 개요](./169-longitudinal-studies-overview.qmd) — 반복 측정 데이터 구조와 공분산

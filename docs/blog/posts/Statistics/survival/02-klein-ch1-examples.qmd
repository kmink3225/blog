...
### 기존 [생존 분석 개요](./01-survival-overview.qmd) 와의 차이
...
* (다음) [Ch.2 — Basic Quantities and Models](./03-klein-ch2-basic-quantities.qmd) (예정)

**기존 입문**

* [생존 분석 개요 (Kleinbaum 기반)](./01-survival-overview.qmd)

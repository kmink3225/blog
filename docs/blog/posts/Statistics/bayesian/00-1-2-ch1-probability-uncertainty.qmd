...
[§ 1.1~1.4 심화](./00-1-1-ch1-bayesian-process.qmd) 가 베이즈 언어의 **문법** 을 세웠다면, § 1.5~1.8 은 그 언어가 **무엇에 관한 언어인가** (확률의 의미) 와 **언어를 구동하는 기술 도구** (확률 이론) 를 다룬다. 교재 전체에서 가장 자주 인용되는 철학적 장과 가장 실용적인 장이 한 자리에 모여 있다.
...
이 관행이 Part III Ch.12 **재매개변수화** 의 기본 어휘다. [§ 1.1~1.4 심화](./00-1-1-ch1-bayesian-process.qmd) 의 혈우병 Metropolis 예제에서도 $\theta \in (0, 1)$ 를 logit 공간으로 옮겨 정규 제안을 썼다.
:::

...
[§ 4.1~4.3 심화](./00-4-1-ch4-normal-approx-asymptotics.qmd) 가 정규 근사와 점근 이론의 **수학적 장치** 를 다뤘다면, 이 포스트는 **그 장치가 빈도주의와 어떻게 만나고 갈라지는지의 해석과 응용** 이다. Ch.4 가 Part I 을 닫는 실용적 매뉴얼인 이유가 여기 있다.
...
- [Ch.4 개요](./00-4-ch4-asymptotics.qmd)
- [§ 4.1~4.3 심화](./00-4-1-ch4-normal-approx-asymptotics.qmd) — 정규 근사·대표본·반례

...
$\theta_1 - \theta_2$ 같은 **파생량의 사후** 는 시뮬레이션으로 쉽게 계산 — 공동 사후에서 표본을 뽑고 함수를 계산만 하면 된다. 이것이 [§ 1.9](./00-1-3-ch1-computation-applied-exercises.qmd) 의 $S \times k$ 표 전략.
...
- [Ch.1 Probability and Inference 개요](./00-1-ch1-probability-inference.qmd) + [§ 1.1~1.4](./00-1-1-ch1-bayesian-process.qmd) · [§ 1.5~1.8](./00-1-2-ch1-probability-uncertainty.qmd) · [§ 1.9·1.10·1.12](./00-1-3-ch1-computation-applied-exercises.qmd)
- [Ch.2 Single-Parameter 개요](./00-2-ch2-single-parameter.qmd) + [§ 2.1~2.4](./00-2-1-ch2-binomial-and-priors.qmd) · [§ 2.5~2.7](./00-2-2-ch2-normal-poisson-cancer.qmd) · [§ 2.8~2.11](./00-2-3-ch2-priors-exercises.qmd)

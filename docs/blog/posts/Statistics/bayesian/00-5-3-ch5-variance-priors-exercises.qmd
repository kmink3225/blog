...
[Ch.5 개요](./00-5-ch5-hierarchical.qmd) 가 계층 모형의 전 지도, [§ 5.1~5.3 심화](./00-5-1-ch5-hierarchical-rat-tumor.qmd) 가 Beta-Binomial, [§ 5.4~5.6 심화](./00-5-2-ch5-normal-eight-schools-meta.qmd) 가 정규·8 학교·메타분석이었다. 이 포스트는 **§ 5.7~5.9 를 통해 Ch.5 와 Part I (Ch.1~5) 을 닫는다**.
...
- [§ 5.1~5.3 심화](./00-5-1-ch5-hierarchical-rat-tumor.qmd)
- [§ 5.4~5.6 심화](./00-5-2-ch5-normal-eight-schools-meta.qmd)

**Part I (Ch.1~5) 전체**

- [Ch.1 개요](./00-1-ch1-probability-inference.qmd) + 세 심화
- [Ch.2 개요](./00-2-ch2-single-parameter.qmd) + 세 심화
- [Ch.3 개요](./00-3-ch3-multiparameter.qmd) + 세 심화
- [Ch.4 개요](./00-4-ch4-asymptotics.qmd) + 두 심화
- [Ch.5 개요](./00-5-ch5-hierarchical.qmd) + 세 심화 (이 포스트 포함)

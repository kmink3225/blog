...
[§ 2.1~2.4](./00-2-1-binomial-and-priors.qmd) 가 이항-Beta, [§ 2.5~2.7](./00-2-2-normal-poisson-cancer.qmd) 이 정규·Poisson·지수·암 발생률 사례였다면, **이 포스트의 § 2.8~2.11 은 "사전 선택의 원리와 응용 훈련"** 이다. 베이즈 비판에서 가장 자주 등장하는 "사전을 어떻게 고르나" 질문에 대한 교재의 답변과, Ch.2 전체를 흡수하는 연습문제 풀이를 함께 다룬다.
...
[Placenta previa 예제](./00-2-1-binomial-and-priors.qmd) 처럼 **$\theta \approx 0.5$** 가 자연스러운 중심.
...
- [Ch.2 개요](./00-2-0-single-parameter.qmd) — 전체 훑기
- [§ 2.1~2.4 심화](./00-2-1-binomial-and-priors.qmd)
- [§ 2.5~2.7 심화](./00-2-2-normal-poisson-cancer.qmd)

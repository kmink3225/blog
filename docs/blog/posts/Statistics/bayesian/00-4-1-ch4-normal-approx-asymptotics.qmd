...
[Ch.4 개요](./00-4-ch4-asymptotics.qmd) 가 점근 이론의 전체 지도였다면, 이 포스트는 **§ 4.1~4.3 을 교재 원문 수준으로 풀어 쓴** 심화편이다. 세 절이 함께 묶이는 이유 — **§ 4.1 이 도구 (정규 근사), § 4.2 가 이론 (왜 정당한가), § 4.3 이 한계 (언제 실패하는가)** 의 삼각 구조.

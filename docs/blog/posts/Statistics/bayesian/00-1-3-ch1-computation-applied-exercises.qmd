...
[§ 1.1~1.4](./00-1-1-ch1-bayesian-process.qmd) 가 **문법**, [§ 1.5~1.8](./00-1-2-ch1-probability-uncertainty.qmd) 이 **의미와 도구 상자** 였다면, **이 포스트의 § 1.9~1.12 는 "실행 · 철학 · 검증"** 이다. 베이즈 분석을 실제로 돌리는 데 필요한 계산 전략 (§ 1.9), 응용 분석에서 Gelman 이 반복 강조하는 아홉 주제 (§ 1.10), 그리고 그 모든 것을 익히는 데 Ch.1 이 남긴 연습문제 (§ 1.12) 의 풀이를 함께 다룬다.
...
$X$ 를 충분히 포함하면 교환가능성 가정이 합리화된다 — [§ 1.2](./00-1-1-ch1-bayesian-process.qmd) 의 핵심.
...
| 심화 포스트 | 교재 절 | 핵심 축 |
|:---|:---|:---|
| [§ 1.1~1.4](./00-1-1-ch1-bayesian-process.qmd) | 3단계 · 표기 · 베이즈 규칙 · 이산 예제 | **문법** |
| [§ 1.5~1.8](./00-1-2-ch1-probability-uncertainty.qmd) | 확률 의미 · 축구 · 링키지 · 확률 결과 | **의미와 도구** |
...
- [Ch.1 Probability and Inference 개요](./00-1-ch1-probability-inference.qmd) — § 1.1~1.9 훑기
- [§ 1.1~1.4 심화](./00-1-1-ch1-bayesian-process.qmd) — 프로세스·표기법·베이즈 추론·이산 예제
- [§ 1.5~1.8 심화](./00-1-2-ch1-probability-uncertainty.qmd) — 확률의 의미·축구·레코드 링키지·확률 이론 도구

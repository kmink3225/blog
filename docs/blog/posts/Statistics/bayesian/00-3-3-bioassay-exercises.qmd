...
[§ 3.1~3.3](./00-3-1-normal-marginalization.qmd) 이 정규 공동 사후, [§ 3.4~3.6](./00-3-2-multinomial-multivariate.qmd) 이 다항·다변량 정규 켤레를 다뤘다면, **이 포스트는 "비켤레 다모수 모델의 실전 계산" 과 "Ch.3 전체 기법을 체화하는 연습"** 을 담는다. Bioassay 예제는 Part III MCMC 가 없던 시대에 이미 **격자 계산만으로 2 모수 비선형 문제를 해결** 한 고전.
...
1988 CBS 예제 ([§ 3.4 심화](./00-3-2-multinomial-multivariate.qmd)) 에서 "Bush vs Dukakis 중 Bush 의 비율" $\alpha = \theta_1/(\theta_1+\theta_2)$ 만 관심이면 $\text{Beta}(728, 584)$ 사후. 기타/무응답 $\theta_3$ 를 무시.
:::
...
- [Ch.3 개요](./00-3-0-multiparameter.qmd)
- [§ 3.1~3.3 심화](./00-3-1-normal-marginalization.qmd) — 주변화·정규 공동 사후
- [§ 3.4~3.6 심화](./00-3-2-multinomial-multivariate.qmd) — 다항·다변량
...
- [Ch.2 개요](./00-2-0-single-parameter.qmd) + [§ 2.1~2.4](./00-2-1-binomial-and-priors.qmd) · [§ 2.5~2.7](./00-2-2-normal-poisson-cancer.qmd) · [§ 2.8~2.11](./00-2-3-priors-exercises.qmd)

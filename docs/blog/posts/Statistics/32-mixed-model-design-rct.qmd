...
> 이 파일은 [20번 연구 설계 대분류](./20-mixed-model-study-design.qmd)의 **RCT/A/B Test** 섹션을 확장한 것이다.
...
**다음 파일**: [33 — 관찰 연구 설계: 코호트, 케이스-컨트롤, 단면 연구](./33-mixed-model-design-observational.qmd)

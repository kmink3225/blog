...
> 이 파일은 [20번 연구 설계 대분류](./20-study-design-overview.qmd)의 **관찰 연구** 섹션을 확장한 것이다.
> 이전 파일: [32 — RCT와 A/B 테스트의 설계 원칙](./32-study-design-rct.qmd)
...
**핵심**: 관찰 연구는 실험이 불가능할 때의 "차선의 방법"이 아니라, 가설 생성과 장기 효과 파악에 **고유한 가치**를 가진다. 다만 교란 변수 통제가 핵심 과제이며, 이를 위한 통계적 기법(매칭, 회귀 조정, 도구 변수)은 [35번 인과 추론 프레임워크](./35-study-design-causal.qmd)에서 다룬다.

---

**다음 파일**: [34 — 준실험적 설계: ITS, RDD, Stepped Wedge](./34-study-design-quasi.qmd)

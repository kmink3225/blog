...
**Epidemiology → Classical A/B Testing → Multi-Armed Bandits → Advanced Methods** 순서로 
실험 설계와 인과추론을 체계적으로 정리
...
* [Epidemiology Overview](./Epidemiology/index.qmd) ⭐
  * 2023-02-27, [Types of Study Designs in Epidemiology](./Epidemiology/study_design.qmd)
  * 2023-05-23, [Measures of Risk: Relative Risk & Odds Ratio](./Epidemiology/relative_risk_odds_ratio.qmd)
...
* Study Design Overview
  * 2026-03-08, [연구 설계 대분류 — Overview](./20-study-design-overview.qmd)
  * 2026-03-08, [각 연구 설계 상세](./21-study-design-details.qmd)
  * 2026-03-08, [타당성, 편향, 인과 추론, 효과 지표](./22-study-design-validity-bias-causal.qmd)
* Experimental and Observational Designs
  * 2026-03-08, [RCT와 A/B 테스트의 설계 원칙](./32-study-design-rct.qmd)
  * 2026-03-08, [관찰 연구 설계: 코호트, 케이스-컨트롤, 단면 연구](./33-study-design-observational.qmd)
  * 2026-03-08, [준실험적 설계: ITS, RDD, Stepped Wedge](./34-study-design-quasi.qmd)
  * 2026-03-08, [인과 추론 프레임워크 총정리](./35-study-design-causal.qmd)
...
> **관련 참조**: 가설 검정, GLM, 분포 이론 등 통계 기초는 [Statistics](../Statistics/index.qmd) 섹션을 참고한다. 특히 [GLM (일반화선형모형)](../Statistics/glm/02-glm-applied-unification.qmd)은 실험 분석에서 핵심적으로 활용된다.
...
* [Statistical Foundations for Experimentation](./Fundamentals/statistics.qmd)
  * 1111-11-11, [Hypothesis Testing Framework](./Fundamentals/hypothesis_testing.qmd)
    ...
    * 2026-04-12, [대표본에서 p-값의 구조적 한계와 실무 대안 지표](../Statistics/170-p-value-large-sample-limitation.qmd)
...
* [Classical A/B Testing](./AB_test/index.qmd) ⭐
  * 2026-03-20, [A/B 테스트 개요](./AB_test/01-ab-test-overview.qmd)
  * 2026-03-16, [A/B 테스트의 핵심 메커니즘](./01-ab-test-mechanism.qmd)
  * 2026-03-16, [전후 비교(Before-and-After)가 위험한 이유](./02-before-after-pitfalls.qmd)
...
* [Advanced A/B Testing Techniques](./AB_test/advanced/index.qmd)
  ...
  * 1111-11-11, [Bayesian Hierarchical Models for Experimentation](./AB_test/advanced/bayesian_hierarchical.qmd)
...
* 2026-03-20, [인과 추론 개요 — 정의, 프레임워크, 방법론 지도](./Causal_Inference/01-causal-inference-overview.qmd)
* 2026-03-20, [인과 효과의 정의와 잠재 결과 — Ch.1](./Causal_Inference/02-causal-effect-definition.qmd)
* 2026-03-20, [무작위 실험과 교환가능성 — Ch.2](./Causal_Inference/03-randomized-experiments.qmd)
* 2026-03-20, [관찰 연구와 식별 조건 — Ch.3](./Causal_Inference/04-observational-studies.qmd)
* 2026-03-20, [효과 수정과 상호작용 — Ch.4-5](./Causal_Inference/05-effect-modification.qmd)
* 2026-03-20, [DAG와 인과 다이어그램 — Ch.6](./Causal_Inference/06-dag-causal-diagrams.qmd)
* 2026-03-20, [교란 — Ch.7](./Causal_Inference/07-confounding.qmd)
* 2026-03-20, [선택 편향 — Ch.8](./Causal_Inference/08-selection-bias.qmd)
* 2026-03-20, [측정 오차와 랜덤 변동 — Ch.9-10](./Causal_Inference/09-measurement-random-variability.qmd)
...
> **관련 참조**: HTE 분석을 기반으로 한 Agent 개인화 전략은 [Agent - Segmentation & Personalization](../Agent/index.qmd#segmentation-personalization) 섹션에서 다룬다. Agent 시스템에서의 사용자 세분화 및 A/B 테스트 적용 사례를 확인할 수 있다.

## Project: AI Agent A/B Test 실험설계
...
* 2026-03-21, [AI Agent A/B 테스트 개요](./AB_test/40-project-agent-ab-overview.qmd)
* 2026-03-21, [오프라인 평가 설계](./AB_test/41-project-agent-offline-eval.qmd)
* 2026-03-21, [Agent 실험 메트릭 설계](./AB_test/42-project-agent-metrics-design.qmd)
* 2026-03-21, [단순 A/B 테스트 설계](./AB_test/43-project-agent-simple-ab.qmd)
* 2026-03-21, [표본 크기와 검정력](./AB_test/44-project-agent-sample-size.qmd)
* 2026-03-21, [Sequential Testing과 조기 종료](./AB_test/45-project-agent-sequential.qmd)
* 2026-03-21, [다중 비교 실험 설계](./AB_test/46-project-agent-multiarm.qmd)
* 2026-03-21, [Human-in-the-Loop 평가](./AB_test/47-project-agent-human-eval.qmd)
* 2026-03-21, [실험 결과 분석과 의사결정](./AB_test/48-project-agent-analysis-decision.qmd)
* 2026-03-21, [Thompson Sampling 동적 라우팅](./AB_test/49-project-agent-thompson-routing.qmd)
* 2026-03-21, [프로덕션 A/B 플랫폼 설계](./AB_test/50-project-agent-production-platform.qmd)

## Analytics Applications

* 1111-11-11, [Conversation Analytics](./conversation_analytics.qmd)
  * 대화 데이터 분석 및 최적화
  * 사용자 인터랙션 패턴 분석
  * 실험을 통한 대화 품질 개선

...
> 이 파일은 [20번 연구 설계 대분류](./20-mixed-model-study-design.qmd)의 **준실험적 설계** 섹션을 확장한 것이다.
> 이전 파일: [33 — 관찰 연구 설계](./33-mixed-model-design-observational.qmd)
...
**다음 파일**: [35 — 인과 추론 프레임워크 총정리](./35-mixed-model-design-causal.qmd)

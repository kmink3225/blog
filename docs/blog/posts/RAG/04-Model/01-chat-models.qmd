...
subtitle: OpenAI, Anthropic, Perplexity 등 주요 LLM 플랫폼 및 모델 상세 분석
description: |
  OpenAI, Anthropic (Claude), Perplexity, Together AI, Cohere, Upstage 등
  주요 Large Language Model (LLM) 제공사의 특징과
  파이썬 기반 연동 코드 예시를 포함하는 모델 활용 가이드.
categories:
  - AI
  - RAG  
author: Kwangmin Kim

---
title: "프롬프트 엔지니어링 기초 - 개요와 분류 체계"
subtitle: 프롬프팅 기법의 전체 분류와 학습 경로
description: |
  프롬프트 엔지니어링의 전체적인 개요와 기법 분류 체계를 소개한다.
  Zero-Shot, Few-Shot, Chain-of-Thought 등 주요 기법의 위치를 조감하고
  이후 개별 기법 학습의 로드맵을 제시한다.
categories:
  - Strategy Frameworks
  - Prompt Engineering
  - AI

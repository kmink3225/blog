...
- [스킬 역분석: Agent용 시스템 프롬프트 작성 원리](./19-agent-skill-prompt-analysis.qmd) — 스킬의 프롬프트 패턴 분석
...
- [스킬 역분석: 시스템 프롬프트 작성 원리](./19-agent-skill-prompt-analysis.qmd) — SKILL.md의 프롬프트 패턴
